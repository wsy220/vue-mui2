...
//	console.log('fromAccount ' + fromAccount);
	...
	if(isSelfSend) { //如果是自己发的消息
		...
		//获取头像
		if(webimLoginInfo.headurl) {
			fromAccountImage = webimLoginInfo.headurl;
		} else {
	...
	//昵称  消息时间
	msghead.innerHTML = "<img class='headurlClass' src='../images/familydoctor/u125.png'>" + "&nbsp;&nbsp;" + webim.Tool.formatText2Html(fromAccountNick + "&nbsp;&nbsp;" + webim.Tool.formatTimeStamp(msg.getTime()));
	//解析消息
...
//			console.log('COMMON ' + convertMsgtoHtml(msg)); //群普通消息
			break;
		case webim.GROUP_MSG_SUB_TYPE.REDPACKET: //群红包消息
			msgPre.innerHTML = "[群红包消息]" + convertMsgtoHtml(msg);
			console.log(convertMsgtoHtml(msg));
			break;
...
//		console.log("show===msglist内容"+document.getElementsByClassName("msgflow")[0].innerHTML);
	if(prepend) {
