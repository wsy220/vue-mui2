...
(function (global, factory) {
  ...
  var getTopMargin = function getTopMargin(elem) {
    ...
    elem.style.left = '';
    elem.style.display = 'none';
    return '-' + parseInt(height / 2 + paddingTop, 50) + 'px';
  };
   ...
   * Animations
   */
  var openModal = function openModal(animation) {
    var modal = getModal();
    if (animation) {
  ...
  function modalDependant() {
    ...
    switch (_typeof(arguments[0])) {
      ...
      default:
        console.error('Unexpected type of argument! Expected "string" or "object", got ' + _typeof(arguments[0]));
        return false;
    }
    ...
    return new Promise(function (resolve) {
      ...
      switch (params.input) {
        ...
        case null:
          break;
        default:
          console.error('Unexpected type of input! Expected "text" or "email" or "password", "select", "checkbox", "textarea" or "file", got ' + _typeof(arguments[0]));
          break;
      }
